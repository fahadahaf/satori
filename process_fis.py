...
def process_FIS(experiment_blob, params, argSpace, device=None, for_background = False):
	...
	if for_background and argSpace.intBackground != None:
		motif_dir = experiment_blob['motif_dir_pos']
	else:
		motif_dir = experiment_blob['motif_dir_neg']
